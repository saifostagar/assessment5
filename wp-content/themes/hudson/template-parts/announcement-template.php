...
<div class="header_banner">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 float-right banner-img">
            ...
            <div class="container single_announce border-bottom py-5">
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                        <h1 class="announce_page_title pt-3"><?php echo substr(get_the_title(), 0, $thelength_title);
							if ($getlength_title > $thelength_title) echo "...";
							?></h1>
                        <div class="announce_page_content pt-3"><?php echo substr(get_the_content(), 0, $thelength_content);
                        if ($getlength_content > $thelength_content) echo "...";
                         ?></div>
                        <h3 class="announce_page_date pt-4"><?php echo get_the_date(); ?></h3>
                    </div>
                </div>
            </div>
    <?php
