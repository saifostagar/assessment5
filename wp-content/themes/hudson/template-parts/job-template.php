...
<div class="container job_page_body">
    ...
    ?>
            <div class="container single_job border-bottom py-5 px-0 pb-20">
                <div class="row">
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-6 col-xs-6 job_details_section">
                        <a class="job_details float-right" href="<?php echo the_permalink(); ?>">View Details</a>
                    </div>

                    <div class="col-md-3 col-lg-3 col-sm-6 col-xs-6 job_apply_section">
                        <a class="job_apply float-right" href="<?php echo the_permalink(); ?>">Apply Now</a>
                    </div>
