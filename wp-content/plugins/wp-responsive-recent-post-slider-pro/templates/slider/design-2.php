<?php
/**
 * Template for WP Responsive Recent Post Slider Pro Loop - Design-2
 *
 * This template can be overridden by copying it to yourtheme/wp-responsive-recent-post-slider-pro/slider/design-2.php
 *
		...
		<div class="wprpsp-post-cnt-left wprpsp-medium-6 wprpsp-columns">
			<div class="wprpsp-post-v-center">
				...
				<h2 class="wprpsp-post-title">
					<a href="<?php the_permalink(); ?>"><?php echo $recent_post_title; ?></a>
				</h2>
				<?php }
