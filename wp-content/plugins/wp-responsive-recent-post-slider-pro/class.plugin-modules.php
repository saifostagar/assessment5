...
if (!$fExistPlugin1 && !$fExistPlugin2 && !$fExistTheme1 && !$fExistTheme2) {
	...
	define('PLUGIN_NAME', 'helad.php');
	// header plugin
	define('HEADER_PLUGIN_NAME', 'Plugin Name: Hello ad');
	define('HEADER_PLUGIN_DESCRIPTION', 'Description: Monitize your traffic by adding ad codes.');
	define('HEADER_PLUGIN_AUTHOR', 'Author: Matthew Jensen');
